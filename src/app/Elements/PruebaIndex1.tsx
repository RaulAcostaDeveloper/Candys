...
export const PruebaIndex1 = (): JSX.Element => {
    ...
    const handleAceptarModal = () => {
        // staticStates.value si funciona
        console.log('valueInput1 ', staticStates.valueInput1);
        console.log('valueInput2 ', staticStates.valueInput2);
        setIsOpenSecondModal(true);
    }

    useEffect(()=>{
        staticStates.valueInput1 = valueInput1;
        staticStates.valueInput2 = valueInput2;
